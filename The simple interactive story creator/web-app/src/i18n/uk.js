export const uk = {
    ...
    mobileSupport: "Нажаль, мобільні пристрої не підтримуються платформою Unity у веб-застосунках. Якщо ви це читаєте на десктопному присторої, то зачекайте поки гра завантажиться або спробуйте перезавантажити сторінку.",
